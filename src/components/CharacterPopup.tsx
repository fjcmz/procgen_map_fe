...
const LANDMARK_LABELS: Record<LandmarkKind, string> = {
  ...
  // Distinctive features (megalopolis-only signature landmarks)
  dist_volcanic_caldera:         'Volcanic Caldera',
  dist_sinkhole_cenote:          'Cenote',
  dist_sky_plateau:              'Sky Plateau',
  dist_ancient_grove:            'Ancient Grove',
  dist_geyser_field:             'Geyser Field',
  dist_bastion_citadel:          'Bastion Citadel',
  dist_triumphal_way:            'Triumphal Way',
  dist_obsidian_wall_district:   'Obsidian Wall',
  dist_siege_memorial_field:     'Siege Memorial',
  dist_under_warrens:            'Under-Warrens',
  dist_floating_spires:          'Floating Spires',
  dist_arcane_laboratorium:      'Arcane Laboratorium',
  dist_ley_convergence:          'Ley-Line Convergence',
  dist_mage_tower_constellation: 'Tower Constellation',
  dist_eldritch_mirror_lake:     'Mirror Lake',
  dist_grand_colosseum:          'Grand Colosseum',
  dist_pleasure_gardens:         'Pleasure Gardens',
  dist_carnival_quarter:         'Carnival Quarter',
  dist_royal_hippodrome:         'Royal Hippodrome',
  dist_opera_quarter:            'Opera Quarter',
  dist_pilgrimage_cathedral:     'Pilgrimage Cathedral',
  dist_necropolis_hill:          'Necropolis Hill',
  dist_pantheon_of_all_gods:     'Pantheon of All Gods',
  dist_shrine_labyrinth:         'Shrine Labyrinth',
  dist_world_tree_pillar:        'World Tree',
  dist_meteor_crater:            'Meteor Crater',
  dist_petrified_titan:          'Petrified Titan',
  dist_crystal_bloom:            'Crystal Bloom',
  dist_ancient_portal_ruin:      'Ancient Portal Ruin',
  dist_time_frozen_quarter:      'Time-Frozen Quarter',
};
