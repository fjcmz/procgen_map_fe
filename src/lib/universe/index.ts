...
export type { SystemKind, PlanetaryStarKind, StandaloneBodyKind, StarSubtype } from './SystemKind';
export { isStandaloneKind } from './SystemKind';
export { SYSTEM_KIND_INFO, STAR_SUBTYPE_HUE, kindInfo, pickSystemKind } from './SystemKindInfo';
export type { SystemKindInfo, KindHue } from './SystemKindInfo';
