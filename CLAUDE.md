...
| Spec | Scope |
|------|-------|
| **[`claude_specs/universe_map.md`](claude_specs/universe_map.md)** | `src/lib/universe/` — Universe → Galaxy → SolarSystem → Star/Planet → Satellite. Generators, naming, galaxy layout, subtype tables, drill-down renderer, hand-off to the world-map flow |
