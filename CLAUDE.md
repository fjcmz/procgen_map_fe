...
| `src/lib/terrain/biomes.ts` | Whittaker biome classification (5 elevation bands including alpine meadow transition) + `BIOME_INFO` palette (19 biome types) + noise-dithered polar thresholds (ICE/SNOW/TUNDRA use `fbmCylindrical` for organic edges instead of hard latitude cutoffs) |
